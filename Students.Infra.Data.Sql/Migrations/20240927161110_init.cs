    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseTecher", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseTecher_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseTecher_Teacher_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseTecher_CourseId",
                table: "CourseTecher",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseTecher_TeacherId",
                table: "CourseTecher",
                column: "TeacherId");
